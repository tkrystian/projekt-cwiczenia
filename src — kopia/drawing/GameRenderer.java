...
public class GameRenderer {
    ...
    public void drawGame(Graphics g, ImageObserver observer, Player player, Bomb bomb, Enemies enemies, ArrayList<BrickWall> brickWalls, ArrayList<Stone> stones) {
        drawGrid(g, observer);
    ...
    public void drawScoreboard(Graphics g, Player player) {
